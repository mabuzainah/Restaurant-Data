...
th {
	...
	<?php
        ...
        $restnum="008";
		$sql="SELECT R.name, R.type, R.url, L.opening_date, L.manager, L.phone_number, L.address, L.Opening_Time, L.Closing_time FROM final_project.Restaurant R, final_project.Location L WHERE R.name ='Subway' AND R.restaurantId= '008' AND R.restaurantId = L.restId";
...
//		}
	...
	?>
	<body>
		<h2>Subway Restaurant Details</h2>
		<table>
			<tr>
        ...
        <script>
            ...
            document.location.href = 'SubwayMenuExp.php';
            });
        </script>
	</body>
</html>